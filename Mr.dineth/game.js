...
loadSprite('chirani', 'ALimKTi.png')
loadSprite('lakshan', 'eYMc3XS.png')
loadSprite('heshan', 'D2U3Tl7.png')
loadSprite('manesh', 'rjWPhVb.png')
loadSprite('company', 'r7IUPSs.png')
...
scene("game", ({ level, score }) => {
    ...
    const levelCfg ={
        ...
        'i': [sprite('banner'),scale(1)],
        'U': [sprite('banner2'),scale(1)],

        'b': [sprite('brick'), solid()],
        'c': [sprite('chirani'), solid()],
        'l': [sprite('lakshan'), solid()],
        'h': [sprite('heshan'), solid()],
        'm': [sprite('manesh'), solid()],
        'p': [sprite('company')],
        'V': [sprite('board')],
        'I': [sprite('board2')],
        'N': [sprite('tree1')],
